...
initdirs
% cplex optim toolbox
addpath /cortex/packages/cplex_optimization/CPLEX_Studio1262/cplex/matlab/x86-64_linux
addpath /cortex/packages/cplex_optimization/CPLEX_Studio1262/cplex/examples/src/matlab/
copt = cplexoptimset('qpmethod', 4, 'threads', 12, 'workmem', 50e3);
...
tic
% Xcplex = cplexqcp(H, f, [], [], Aeq, beq, [], [], [], [], [], [], copt );
Xqp = quadprog(H, f, [], [], Aeq, beq);
toc
